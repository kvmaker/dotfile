...
- ripd
  ...
  3. 配置
	 - u0
	   #+begin_src sh
       # 建立到达u1的隧道
       yubo@u0:~$ ip tunnel add ipip mode ipip local 10.67.226.203 remote 10.68.167.208
     ...
     - u1
	   #+begin_src sh
       # 建立达到u0的隧道
       yubo@u1:~$ ip tunnel add ipip mode ipip remote 10.67.226.203 local 10.68.167.208
